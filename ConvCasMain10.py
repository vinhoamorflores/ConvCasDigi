...
def main(page: ft.Page):
    ...
    def mostrar_tela_confirmar():
        page.controls.clear()
        conteudo = ft.Text("Confirmar Presença", size=28, weight="bold", color=ft.Colors.BLUE_900)
        page.add(criar_layout_base(conteudo, cor_inferior=ft.Colors.with_opacity(0.5, ft.Colors.BLUE_900)))
        page.update()

    def mostrar_tela_presentes():
        page.controls.clear()
        conteudo = ft.Text("Lista de Presentes", size=28, weight="bold", color=ft.Colors.BROWN_900)
        page.add(criar_layout_base(conteudo, cor_inferior=ft.Colors.with_opacity(0.5, ft.Colors.BROWN_100)))
        page.update()

    def mostrar_tela_local():
        page.controls.clear()
        conteudo = ft.Text("Local do Evento", size=28, weight="bold", color=ft.Colors.RED_900)
        page.add(criar_layout_base(conteudo, cor_inferior=ft.Colors.with_opacity(0.5, ft.Colors.RED_100)))
        page.update()
