...
def main(page: ft.Page):
    ...
    # --- Nomes dos Arquivos (Devem estar dentro da pasta /assets) ---
    ...
    # --- Funções de Utilidade (Otimizadas para Web) ---

    def obter_image_principal(opacidade):
        return ft.Image(
            src=IMG_CONVITE,
            fit=ft.BoxFit.FILL,
    ...
    def obter_imagem_botao(nome_arquivo, icone_reserva, acao):
        # Tentamos carregar a imagem; se falhar, o error_content assume o controle
    ...
    def criar_layout_base(conteudo_superior, cor_inferior=ft.Colors.with_opacity(0.3, ft.Colors.BLUE_200), opacidade_fundo=0.15):
        return ft.Stack(
            ...
            controls=[
                ft.Container(
                    content=obter_image_principal(opacidade_fundo),
                    alignment=ft.Alignment.CENTER,
                ),
                ft.Column(
                    expand=True,
